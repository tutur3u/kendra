...
export function ProfileAndLinksSection({
	...
	return (
		<FormSection
			defaultOpen
			description="Main identity, booking links, and public image paths."
			kicker="Pages"
		...
		>
			<div className="grid gap-4 md:grid-cols-2">
				...
				<TextInput
					...
					onChange={(value) => updateSite("clientProofImage", value)}
					...
					>
						<div className="grid gap-3 md:grid-cols-2">
							...
							<TextInput
								...
								label="Logo image"
								onChange={(value) => onUpdateClientLogo(index, "image", value)}
								value={logo.image}
							/>
						</div>
						<RowActions
